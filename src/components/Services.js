                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We offer constant monitoring of our application at not extra cost. We also provide an very straightfoward way of update data within your system. This is cludes the most update-to-date security processses to keep your data safe. </p>
                            </div>
                        </div>
                    </div>
                </div>
